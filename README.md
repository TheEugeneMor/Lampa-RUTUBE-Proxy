...
2. Он показывает ссылку вида `http://192.168.x.x:8787/rt.php`.
...
```text
http://your-domain.example:8787/rt.php
```
...
- `server/rt.php` - рекомендуемый файл для подключения в Lampa.
- `server/rt.js` - код плагина Lampa, который отдает `rt.php`.
